...
import BraziliansAbroad from './components/BraziliansAbroad';
...
export default function App() {
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[60] focus:bg-sage-500 focus:text-white focus:px-4 focus:py-2 focus:rounded-xl"
      >
